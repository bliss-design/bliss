import type { ComponentPropsWithoutAs } from './with-polymorphic.types';

import React from 'react';

export default function withoutAsPolymorphic<
  DefaultElement,
  Props,
  StaticProps = Record<string, never>,
>(Component: React.ElementType) {
  type ComponentWithProps<Element> = ComponentPropsWithoutAs<Element, Props>;
